    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				<div class="logo-abbr" >
					<img style="width:50px;height:50px;" src="images/logos/pic1.jpg" alt="">
				</div>
            </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<div class="main-profile">
					...
					<h5 class="name"><span class="font-w400">Hello,</span> Yassine</h5>
        ...
        <div class="content-body">
			<div class="container-fluid">
				<div class="form-head mb-4 mb-sm-5 d-flex  flex-wrap align-items-center ">
					<h2 class="font-w600 mb-0 mr-auto">Market Capital</h2>
					<select class="btn-secondary style-1 default-select mr-3 ">
						<option>USD</option>
						<option>USD</option>
						<option>USD</option>
					</select>
					<a href="javascript:void(0);" class="btn btn-outline-primary"><i class="las la-calendar scale5 mr-2"></i>Filter Periode</a>
				</div>
			</div>
		</div>
    </div>
        ...
        ***********************************-->
		<div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../index.html" target="_blank">Ahmed Yassine El hamzaoui</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
